...
@Component({
    templateUrl: './hw-from-angular-comp.component.html',
    styleUrls: ['./hw-from-angular-comp.component.css']
})
export class HWFromAngularCompBaseComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    public $config: any = {
        components: {
            customhelloworldangcomp0 : {
    "greeting": "Salutations th"
}
        }
    };
