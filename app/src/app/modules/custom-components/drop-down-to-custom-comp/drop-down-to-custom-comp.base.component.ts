...
@Component({
    templateUrl: './drop-down-to-custom-comp.component.html',
    styleUrls: ['./drop-down-to-custom-comp.component.css']
})
export class DropDownToCustomCompBaseComponent implements OnInit, AfterViewInit, OnDestroy {
