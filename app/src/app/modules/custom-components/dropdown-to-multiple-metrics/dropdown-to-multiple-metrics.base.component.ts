...
@Component({
    templateUrl: './dropdown-to-multiple-metrics.component.html',
    styleUrls: ['./dropdown-to-multiple-metrics.component.css']
})
export class DropdownToMultipleMetricsBaseComponent implements OnInit, AfterViewInit, OnDestroy {
...
,
            customdevicemultiplemetricscomp1 : {
    "metric": "All Metrics"
}
        }
    };
